    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MedicalDeviceTypes", x => x.MedicalDeviceTypeId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    CompanyManagerId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    CompanyId = table.Column<int>(type: "int", nullable: false),
                    ApplicationUserId = table.Column<string>(type: "nvarchar(450)", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_CompanyManagers", x => x.CompanyManagerId);
                    table.ForeignKey(
                        name: "FK_CompanyManagers_AspNetUsers_ApplicationUserId",
                        column: x => x.ApplicationUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_MedicalDevices_Manufacturers_ManufacturerId",
                        column: x => x.ManufacturerId,
                        principalTable: "Manufacturers",
                        principalColumn: "ManufacturerId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_MedicalDevices_MedicalDeviceTypes_MedicalDeviceTypeId",
                        column: x => x.MedicalDeviceTypeId,
                        principalTable: "MedicalDeviceTypes",
                        principalColumn: "MedicalDeviceTypeId",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Measurements_MedicalDevices_MedicalDeviceId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CompanyManagers_ApplicationUserId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Measurements_MedicalDeviceId",
                table: "Measurements",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MedicalDevices_ManufacturerId",
                table: "MedicalDevices",
                column: "ManufacturerId");

            migrationBuilder.CreateIndex(
                name: "IX_MedicalDevices_MedicalDeviceTypeId",
                table: "MedicalDevices",
